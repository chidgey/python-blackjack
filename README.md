[![Build Status](https://travis-ci.org/chidgey/python-blackjack.svg?branch=master)](https://travis-ci.org/chidgey/python-blackjack) [![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?project=python-blackjack&metric=alert_status)](https://sonarcloud.io/dashboard?id=python-blackjack)

# Blackjack

Blackjack is the American variant of a globally popular banking game known as Twenty-One, whose cousins include Pontoon and Vingt-et-Un. It is a comparing card game between usually several players and a dealer, where each player in turn competes against the dealer, but players do not play against each other. It is played with one or more decks of 52 cards, and is the most widely played casino banking game in the world.
